	...
	countdown.each(function() {
		...
		$countdown.countdown(finalDate, function(event) {
			$countdown.html(event.strftime(
				'<div class="row"><div class="col"><div class="text-12 fw-600 px-sm-3">%-D</div><span class="fw-300 opacity-9">Día%!d</span></div><div class="col"><div class="text-12 fw-600 px-sm-3">%H</div><span class="fw-300 opacity-9">Hrs</span></div><div class="col"><div class="text-12 fw-600 px-sm-3">%M</div><span class="fw-300 opacity-9">Min</span></div><div class="col"><div class="text-12 fw-600 px-sm-3">%S</div><span class="fw-300 opacity-9">Seg</span></div></div>'
			));
		});
	});
}
